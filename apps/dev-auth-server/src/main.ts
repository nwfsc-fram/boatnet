...
app.use('/api/' + API_VERSION + '/user-details', validateJwtRequest);
app.route('/api/' + API_VERSION + '/user-details').get(getUserDetails);
app.route('/api/' + API_VERSION + '/user-details').put(putUserDetails);
