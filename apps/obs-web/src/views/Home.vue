  ...
  <q-page class="flex flex-center q-pa-md">
    ...
    <div v-if="onlineStatus">
      ...
      <div v-if="activeUser && !isSyncing" style="display: block; text-align: center">
        ...
        <q-btn v-if="!isAuthorized(['enforcement'])" label="Trips" to="/trips" color="primary" exact style="margin: 5px"></q-btn>

        <q-btn v-if="!isAuthorized(['enforcement'])" label="Logbook Capture" to="/log-book-capture" color="primary" exact style="margin: 5px"></q-btn>
