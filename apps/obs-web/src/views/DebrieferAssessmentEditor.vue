            ...
            <q-tr :props="props">
              <q-td key="section" :props="props">
                ...
                <q-popup-edit v-model="props.row.section" buttons persistent @save="save(props.row)">
                    <q-select v-model="props.row.section" :options="debriefer.program === 'wcgop' ? wcgopSections : ashopSections" dense></q-select>
                </q-popup-edit>
              </q-td>
            ...
            <q-tr :props="props">
              <q-td key="name" :props="props">
                ...
                <q-popup-edit v-model="props.row.name" buttons persistent @save="save(props.row)">
                    <q-input v-model="props.row.name" :options="wcgopSections" dense></q-input>
                </q-popup-edit>
              </q-td>
              <q-td key="options" :props="props">
                {{ getOptionsString(props.row.options) }}
...
export default createComponent({
  ...
  setup(props, context) {
    ...
    const ashopSections: any = [
      'Observer Logbook',
      'Fish Identification',
      'Data Forms',
      'Haul Information (Trip, OHF & VHF, Offload)',
      'Sampling Design Information',
      'Composition Information',
      'Length / Biological Information',
      'Seabird & Marine Mammal Information',
      'Standard Project and Research Project Information',
    ...
    const getQuestions = async () => {
      ...
      if (results.rows) {
        ...
        questions.value = sortBy(results.rows.map( (row: any) => row.doc ), ['section', 'order'] );
      }
    };
    ...
    const getAnswerSets = async () => {
      ...
      if (results.rows) {
        ...
        answers.value = results.rows.map( (row: any) => row.doc );
        answerSetNames.value = answers.value.map( (row: any) => row.name );
      }
    };

    const getOptionsString = (array: any) => {
