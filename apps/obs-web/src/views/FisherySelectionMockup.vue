...
export default createComponent({
  setup(props, context) {
    ...
    const fisheries = [
        ...
        {description: 'LE Trawl ITQ', lookupValue: 'LE Trawl ITQ', sectors: [{description: 'Mothership Catcher Vessel'}, {description: 'Midwater Rockfish'}, {description: 'Bottom Trawl'}, {description: 'Fixed Gear'}, {description: 'Shoreside Hake'}], isEm: false, isEfp: false, isFederal: true, isRetentionFishery: false},
        {description: 'LE Trawl ITQ EM', lookupValue: 'LE Trawl ITQ EM', sectors: [{description: 'Mothership Catcher Vessel'}, {description: 'Midwater Rockfish'}, {description: 'Bottom Trawl'}, {description: 'Fixed Gear'}, {description: 'Shoreside Hake'}], isEm: true, isEfp: true, isFederal: true, isRetentionFishery: true},
