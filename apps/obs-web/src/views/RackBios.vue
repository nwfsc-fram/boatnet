  ...
  <div id="q-app">
    <div>
      <q-card>
          ...
          >
            <q-tab name="rack" label="Rack"></q-tab>
            <q-tab name="report" label="Report"></q-tab>
          </q-tabs>
          ...
          <q-tab-panels
            ...
            keep-alive
          >
            <q-tab-panel name="rack">
              <app-scan-barcodes type="rack"/>
            </q-tab-panel>
            <q-tab-panel name="report">
              <app-process-biostructures type="rack"/>
            </q-tab-panel>
          </q-tab-panels>
      </q-card>
    </div>
