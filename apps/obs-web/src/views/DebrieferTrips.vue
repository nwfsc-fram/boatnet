    ...
    >
      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          ...
          <q-td key="tripStatus" :props="props" @click.native="selectRow(props.row.__index,'tripStatus')" :class="selected.hasOwnProperty(props.row.__index) && selected[props.row.__index].indexOf('tripStatus')!=-1?'bg-grey-2':''">{{ props.row.tripStatus.description }}</q-td>
          <q-td key="vessel" :props="props" @click.native="selectRow(props.row.__index,'vessel')" :class="selected.hasOwnProperty(props.row.__index) && selected[props.row.__index].indexOf('vessel')!=-1?'bg-grey-2':''">{{ props.row.vessel.vesselName }}</q-td>
