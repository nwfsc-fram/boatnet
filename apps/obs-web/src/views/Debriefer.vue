                ...
                :visible-columns="visibleCatchColumns"
                  ...
                  <template v-slot:body="props">
                    <q-tr :props='props'>
                      ...
                      <q-td key="catchWM" :props="props">{{ props.row.catch.weightMethod.description }}</q-td>
                      <q-td key="catchWeight" :props="props">{{ props.row.catch.weight.value }}</q-td>
                      <q-td key="catchSpecies" :props="props">{{ props.row.catch.species.species.commonName }}</q-td>
                    </q-tr>
                  </template>
...
private visibleOperationColumns = ['tripKey', 'operationNum','catches','position','location','observerTotalCatch','gearType','gearPerformance','targetStrategy',
...
private visibleCatchColumns = ['tripKey', 'operationNum','catchNum','disposition','catchWM','catchWeight','catchSpecies'];
...
private operationColumns = [
    ...
    {name: 'catches', label: 'Catches', field: 'catches', align: 'left', sortable: true },
...
private catchColumns = [
    ...
    {name: 'gearSegmentsLost', label: 'Gear Segments Lost', field: 'gearSegmentsLost', align: 'left', sortable: true },
    {name: 'hooksSampled', label: 'Hooks Sampled', field: 'hooksSampled', align: 'left', sortable: true },
    {name: 'catchNum', label: 'Catch #', field: 'catchNum', align: 'left', sortable: true },
    {name: 'disposition', label: 'Catch Disposition', field: 'disposition', align: 'left', sortable: true },
    {name: 'catchWM', label: 'Catch WM', field: 'catchWM', align: 'left', sortable: true },
    {name: 'catchWeight', label: 'Catch Weight (lbs)', field: 'catchWeight', align: 'left', sortable: true },
    {name: 'catchSpecies', label: 'Catch Species', field: 'catchSpecies', align: 'left', sortable: true }
