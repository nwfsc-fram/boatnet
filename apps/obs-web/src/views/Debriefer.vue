      ...
      <q-card>
        ...
        <q-tab-panels v-model="tab" animated>
          ...
          <q-tab-panel name="catch">
            <div class="text-h6">Catch</div>Lorem ipsum dolor sit amet consectetur adipisicing elit.
          </q-tab-panel>
          ...
          <q-tab-panel name="specimens">
            <div class="text-h6">Specimens</div>Lorem ipsum dolor sit amet consectetur adipisicing elit.
          </q-tab-panel>
        </q-tab-panels>
      </q-card>
    </div>
