...
import DebrieferSamples from './views/DebrieferSamples.vue';
import DebrieferSpeciesIneractions from './views/DebrieferSpeciesInteractions.vue';
...
import ScanBarcodes from './views/ScanBarcodes.vue';
import ProcessBiostructures from './views/ProcessBiostructures.vue';
import BiospecimensReport from './views/BiospecimensReport.vue';
...
Vue.component('appDebrieferSamples', DebrieferSamples);
Vue.component('appDebrieferSpeciesInteractions', DebrieferSpeciesIneractions);
...
Vue.component('appScanBarcodes', ScanBarcodes);
Vue.component('appProcessBiostructures', ProcessBiostructures);
Vue.component('appBiospecimensReport', BiospecimensReport);
