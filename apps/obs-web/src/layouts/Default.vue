      ...
      <q-list condensed>
        ...
        >
          ...
          >
            ...
            <q-item-section>
              <q-item-label>Vessel Selections</q-item-label>
              <q-item-label caption>view vessel selections and rollover status</q-item-label>
            </q-item-section>
          </q-item>
        ...
        <q-expansion-item
          v-if="isAuthorized(['development_staff', 'staff', 'data_steward', 'program_manager', 'coordinator', 'debriefer', 'provider']) && !getCaptainMode && !getObserverMode"
