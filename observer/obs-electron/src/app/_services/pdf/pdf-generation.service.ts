...
export class PdfGenerationService {
  ...
  generateTallyPdf(tallyDataDef: TallyData, date: string, tripId: string, haulId: string) {
    ...
    pdfMake.createPdf(docDefinition).download(`tally-${fileDate}-${tripId}-${haulId}.pdf`);
  }
}
