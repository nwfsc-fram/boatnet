...
export class SpeciesCompositionComponent
  ...
  ngOnInit() {
    ...
    // Tree Composition
    this.data = <SpeciesCompNode[]>(
      SampleData[this.appConfig.program.toLowerCase()]
    );
  }
  ngOnDestroy() {
  ...
  filterSpecies(value: string) {
    const temp = this.speciesList.filter(
      species =>
        species['visibleName'].toLowerCase().indexOf(value.toLowerCase()) === 0
    );
    const temp2 = this.speciesList.filter(
      species =>
        species['visibleName'].toLowerCase().indexOf(value.toLowerCase()) > 0
    );
  ...
  sortAlphabetical(arr: Array<Species>) {
    ...
    return arr.sort((a, b) =>
      a['visibleName'].localeCompare(b['visibleName'], undefined, {
        sensitivity: 'base'
      })
    );
  }
  ...
  searchSpeciesComp(
    searchNode: Species,
    currentNode?: SpeciesCompNode,
    parentNode?: SpeciesCompNode
  ) {
    // console.log('currentNode = ' + currentNode);
    if (currentNode) {
      console.log(
        currentNode.data['species'] +
          ', ' +
          currentNode.data['taxonomyId'] +
          ' =? ' +
          searchNode['taxonomyId']
      );
    ...
    if (parentNode) {
      // parentNode exists, not the root level
      if (parentNode.children) {
        children = parentNode.children;
      }
    } else {
      // no parentNode, i.e. root level
      children = this.data;
    }
  ...
  addSpecies() {
    if (this.selectedSpecies !== null) {
      ...
      if (!this.searchSpeciesComp(this.selectedSpecies)) {
        ...
        const _catch = this.catchType.createCatch(
          1,
          this.selectedSpecies.taxonomyId,
          this.selectedSpecies.commonName,
          protocol,
          ''
        );
...
const fullSpeciesList = [
  {
    commonName: 'Pacific hake',
    taxonomyId: 22500,
    scientificName: '',
    visibleName: 'Pacific hake'
  },
  {
    commonName: 'Humboldt squid',
    taxonomyId: 79265,
    scientificName: '',
    visibleName: 'Humboldt squid'
  },
  {
    commonName: 'Pacific ocean perch',
    taxonomyId: 30060,
    scientificName: '',
    visibleName: 'Pacific ocean perch'
  },
  {
    commonName: 'walleye pollock',
    taxonomyId: 21740,
    scientificName: '',
    visibleName: 'walleye pollock'
  },
  {
    commonName: 'widow rockfish',
    taxonomyId: 30220,
    scientificName: '',
    visibleName: 'widow rockfish'
  },
  {
    commonName: 'yellowtail rockfish',
    taxonomyId: 30240,
    scientificName: '',
    visibleName: 'yellowtail rockfish'
  },
  {
    commonName: 'Pacific herring',
    taxonomyId: 21110,
    scientificName: '',
    visibleName: 'Pacific herring'
  },
  {
    commonName: 'yellowmouth rockfish',
    taxonomyId: 30600,
    scientificName: '',
    visibleName: 'yellowmouth rockfish'
  },
  {
    commonName: 'redstripe rockfish',
    taxonomyId: 30430,
    scientificName: '',
    visibleName: 'redstripe rockfish'
  },
  {
    commonName: 'rougheye rockfish',
    taxonomyId: 30051,
    scientificName: '',
    visibleName: 'rougheye rockfish'
  },
  {
    commonName: 'jack mackerel',
    taxonomyId: 20952,
    scientificName: '',
    visibleName: 'jack mackerel'
  },
  {
    commonName: 'eulachon',
    taxonomyId: 23010,
    scientificName: '',
    visibleName: 'eulachon'
  },
  {
    commonName: 'chinook salmon',
    taxonomyId: 23220,
    scientificName: '',
    visibleName: 'chinook salmon'
  },
  {
    commonName: 'sharpchin rockfish',
    taxonomyId: 30560,
    scientificName: '',
    visibleName: 'sharpchin rockfish'
  },
  {
    commonName: 'Myctophidae',
    taxonomyId: 22600,
    scientificName: '',
    visibleName: 'Myctophidae'
  },
  {
    commonName: 'jellyfish unident.',
    taxonomyId: 40500,
    scientificName: '',
    visibleName: 'jellyfish unident.'
  },
  {
    commonName: 'silvergray rockfish',
    taxonomyId: 30100,
    scientificName: '',
    visibleName: 'silvergray rockfish'
  },
  {
    commonName: 'arrowtooth flounder',
    taxonomyId: 10110,
    scientificName: '',
    visibleName: 'arrowtooth flounder'
  },
  {
    commonName: 'Pyrosoma sp.',
    taxonomyId: 98003,
    scientificName: '',
    visibleName: 'Pyrosoma sp.'
  },
  {
    commonName: 'splitnose rockfish',
    taxonomyId: 30190,
    scientificName: '',
    visibleName: 'splitnose rockfish'
  },
  {
    commonName: 'Euphausiacea',
    taxonomyId: 63500,
    scientificName: '',
    visibleName: 'Euphausiacea'
  },
  {
    commonName: 'brown cat shark',
    taxonomyId: 210,
    scientificName: '',
    visibleName: 'brown cat shark'
  }
];

const fullSpeciesList2 = [
  'Pacific hake',
  'Humboldt squid',
  'Pacific ocean perch',
  'walleye pollock',
