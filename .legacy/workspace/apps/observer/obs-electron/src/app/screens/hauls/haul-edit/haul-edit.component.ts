...
import { Location } from '@boatnet/bn-models';
...
export class HaulEditComponent implements OnInit {
  ...
  locations: Location[] = [
    // tslint:disable-next-line:max-line-length
    {
      ...
      created_date: 'Fri Jul 13 2018 13:27:44 GMT-0800',
      location_type: 'set',
      date_time: 'Fri Jul 13 2018 13:27:44 GMT-0800',
      lat: "+31°12.12'",
      lon: "-122°35.32'",
      fishing_depth: '123',
      bottom_depth: '456'
    },
    {
      ...
      type: 'location',
      created_by: 'Seth Gerou',
      created_date: 'Thu Jul 12 2018 13:27:44 GMT-0700',
      location_type: 'up',
      date_time: 'Thu Jul 12 2018 13:27:44 GMT-0700',
      lat: '47.65725',
      lon: '123.56774',
      fishing_depth: '123',
      bottom_depth: '456'
    },
    {
      ...
      type: 'location',
      created_by: 'Seth Gerou',
      created_date: 'Thu Jul 12 2018 13:27:44 GMT-1000',
      location_type: 'type1',
      date_time: 'Thu Jul 12 2018 13:27:44 GMT-1000',
      lat: '47.65725',
      lon: '123.56774',
      fishing_depth: '123',
      bottom_depth: '456'
  ...
  beaufortScaleOptions = [
    {
      value: 0,
      label: '0',
      desc: 'Sea (glassy, calm) - Wind (0-1 kts, calm) - Wave Height (flat)'
    },
    {
      value: 1,
      label: '1',
      desc:
        'Sea (light ripple) - Wind (1-4 kts, light air) - Wave Height (.25ft)'
    },
    {
      value: 2,
      label: '2',
      desc: 'Sea (small wavelets) - Wind (0-1 kts, calm) - Wave Height (flat)'
    },
    {
      value: 3,
      label: '3',
      desc:
        'Sea (scattered whitecaps) - Wind (0-1 kts, calm) - Wave Height (flat)'
    },
    {
      value: 4,
      label: '4',
      desc:
        'Sea (small waves, frequent whitecaps) - Wind (0-1 kts, calm) - Wave Height (flat)'
    },
    {
      value: 5,
      label: '5',
      desc:
        'Sea (moderate waves, many whitecaps) - Wind (0-1 kts, calm) - Wave Height (flat)'
    },
    {
      value: 6,
      label: '6',
      desc:
        'Sea (all whitecaps, some spray) - Wind (0-1 kts, calm) - Wave Height (flat)'
    },
    {
      value: 7,
      label: '7',
      desc:
        'Sea (breaking waves, spindrift) - Wind (0-1 kts, calm) - Wave Height (flat)'
    },
    {
      value: 8,
      label: '8',
      desc:
        'Sea (medium high waves, foamy streaks) - Wind (0-1 kts, calm) - Wave Height (flat)'
    },
    {
      value: 9,
      label: '9',
      desc:
        'Sea (high waves, dense foamy streaks) - Wind (0-1 kts, calm) - Wave Height (flat)'
    }
  ];

  booleanValues = [{ value: true, label: 'Y' }, { value: false, label: 'N' }];

  emObsOptions = [{ value: 0, label: 'EM' }, { value: 1, label: 'Observer' }];
  ...
  createEditForm() {
    this.haulForm = this.fb.group({
      ...
      percent_marine_mammal_monitored: this.haul
        .percent_marine_mammal_monitored,
  ...
  createEditLocationForm() {
    ...
    this.locationForm = this.fb.group({
      ...
      time:
        new Date(activeLocation.date_time).getHours() +
        ':' +
        new Date(activeLocation.date_time).getMinutes()
    });
  }
  ...
  onGearSelect(event) {
    ...
    this.displayOptions.gear_perf =
      this.currentGearType === 'Fixed Gear' ? true : false;
  ...
  onLocationSubmit() {
    this.locationId = String(
      parseInt(this.locations[this.locations.length - 1].id) + 1
    );
    ...
    if (formModel.id) {
      ...
      const edited = this.locations.find(function(x) {
    ...
    this.locations.push(saveLocation);
    this.displayDialog = false;
