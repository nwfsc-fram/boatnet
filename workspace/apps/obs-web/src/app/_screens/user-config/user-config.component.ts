...
export class UserConfigComponent implements OnInit {
  ...
  notification_options = [
    ...
    {
      label: 'device notification (push)',
      value: 'notification',
      icon: 'pi pi-mobile'
    }
  ];
  ...
  vessel_options = [
    {
      label: 'Excalibur',
      value: { vessel_name: 'Excalibur', vessel_reg_num: 'WA984325' }
    },
    {
      label: 'Last Straw',
      value: { vessel_name: 'Last Straw', vessel_reg_num: 'CA984325' }
    },
    {
      label: 'Raven',
      value: { vessel_name: 'Raven', vessel_reg_num: 'OR984325' }
    },
    {
      label: 'Ms Julie',
      value: { vessel_name: 'Ms Julie', vessel_reg_num: 'CA984325' }
    }
  ];
