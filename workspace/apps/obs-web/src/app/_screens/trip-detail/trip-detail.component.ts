...
export class TripDetailComponent implements OnInit {
  ...
  currentUser =
    this.stateSvc.currentState.user.first_name +
    ' ' +
    this.stateSvc.currentState.user.last_name;
  ...
  permits = [
    {
      label: 'GF0001 - Limited Entry - Catch Shares',
      value: {
        id: 'A21rv35',
        type: 'permit',
        permit_num: 'GF0001',
    ...
    {
      label: '90011 - Trawl Gear - MOD EFP',
      value: {
        id: 'W32be87',
        type: 'permit',
        permit_num: '90011',
    ...
    {
      label: '777qwe - Catch Shares - Shore Side Hake',
      value: {
        id: 'N11es32',
        type: 'permit',
        permit_num: '777qwe',
  ...
  ngOnInit() {
    ...
    if (this.stateSvc.currentState.trip === undefined) {
      this.trip = Trip.createTrip(
        this.stateSvc.currentState.user.home_port,
        this.stateSvc.currentState.vessel.vessel_name
      );
    }
