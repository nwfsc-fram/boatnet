...
export class OTSManagementComponent implements OnInit {
  ...
  ots_coverages = [
    {
      coverage_type: 'fishery',
      coverage_target: 'Catch Shares - Shore Side Hake',
      rate: '22%',
    ...
    {
      coverage_type: 'fishery',
      coverage_target: 'Limited Entry - Catch Shares',
      rate: '35%',
      start_date: '10/12/2018',
      end_date: '10/12/2018'
    },
    {
      coverage_type: 'fishery',
      coverage_target: 'Trawl Gear - MOD EFP',
      rate: '45%',
      start_date: '10/12/2018',
      end_date: '10/12/2018'
    },
  ...
  constructor(private stateSvc: StateService) {
    this.data = {
      ...
      datasets: [
        {
          data: [
            Math.floor(Math.random() * Math.floor(101)),
            Math.floor(Math.random() * Math.floor(101))
          ],
