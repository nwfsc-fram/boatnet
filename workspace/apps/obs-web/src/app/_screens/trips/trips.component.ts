...
export class TripsComponent implements OnInit {
  trips: any = [
    {
      ...
      trip_num: '3',
      vessel: 'Excalibur',
      coast_guard_number: 'fgr243rt',
      start_date: '8/03/2018 10:01 AM',
      end_date: '8/20/2018 3:33 PM',
      is_open: false,
      selected: false,
      start_port: 'Newport',
    ...
    },
    {
      ...
      start_date: '9/9/2018 10:01 AM',
      end_date: '9/17/2018 3:33 PM',
      is_open: false,
      selected: true,
      start_port: 'Newport',
      end_port: 'same as start',
    ...
    },
    {
      ...
      start_date: '10/23/2018 10:01 AM',
      end_date: '10/31/2018 3:33 PM',
      is_open: false,
      selected: false,
      start_port: 'Newport',
      end_port: 'same as start',
    ...
    },
    {
      ...
      start_date: '11/7/2018 10:01 AM',
      end_date: '11/23/2018 3:33 PM',
      is_open: 'active',
      selected: true,
      start_port: 'Newport',
      end_port: 'same as start',
    ...
    },
    {
      ...
      start_date: '12/1/2018 10:01 AM',
      end_date: '12/15/2018 3:33 PM',
      is_open: 'active',
      selected: false,
      start_port: 'Newport',
      end_port: 'same as start',
  ...
  ngOnInit() {
    ...
    if (this.stateSvc.currentState.vessel === undefined) {
      this.stateSvc.setVessel({
        vessel_name: 'Excalibur',
        coast_guard_number: 'fgr243rt',
        state_reg_number: '12fef23',
    ...
    if (!this.dataService.initialSyncComplete.getValue()) {
      this.dataService.connectDatabase('test', 'test');
    }
