...
import { BnAuthModule, AuthService, AuthServiceConfig } from '@boatnet/bn-auth';
...
const appRoutes: Routes = [
  ...
  {
    path: 'ots-management',
    component: OTSManagementComponent,
    canActivate: [AuthGuard]
  },
  {
    path: 'ots-target-detail',
    component: OtsTargetDetailComponent,
    canActivate: [AuthGuard]
  },
  {
    path: 'manage-users',
