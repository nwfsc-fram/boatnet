...
export class HaulsComponent implements OnInit {
  ...
  displayedColumns = ['status', 'haulNumber', 'startDate', 'endDate', 'haulType'];
  ...
  createHauls() {
    ...
    for (const haul of HAUL_DATA) {
      newHaul = AcousticHaul.createAcousticHaul(haul['haulNumber'],
                              haul['gearType'], haul['startDate'], haul['username'], haul['haulType'])
...
const HAUL_DATA = [
  {haulNumber: '1', gearType: 'Trawl', startDate: '06/24/2018 13:45:00', username: 'Todd Hay', haulType: 'Net Tow'},
  {haulNumber: '2', gearType: 'Trawl', startDate: '06/24/2018 15:13:00', username: 'Todd Hay', haulType: 'Methot Tow'},
  {haulNumber: '3', gearType: 'Trawl', startDate: '06/23/2018 18:13:00', username: 'Todd Hay', haulType: 'Methot Tow'},
  {haulNumber: '4', gearType: 'Trawl', startDate: '06/22/2018 18:13:00', username: 'Todd Hay', haulType: 'Net Tow'},
  {haulNumber: '5', gearType: 'Trawl', startDate: '06/18/2018 18:13:00', username: 'Todd Hay', haulType: 'Net Tow'},
  {haulNumber: '6', gearType: 'Trawl', startDate: '05/03/2018 18:13:00', username: 'Todd Hay', haulType: 'Net Tow'},
];
