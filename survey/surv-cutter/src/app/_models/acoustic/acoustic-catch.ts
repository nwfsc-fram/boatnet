...
export class AcousticCatch implements Catch {
  ...
  static createCatch(catchNumber: number, taxonomyId: number, species: string,
...
export const AcousticCatchConfig = {
  ...
  cols: [
    ...
    {field: 'totalWeight', header: 'Weight', type: 'number', uom: 'kg', width: '120px'},
    {field: 'protocol', header: 'Protocol', type: 'string', width: '300px'}
  ], grouping: 'Mix', subgrouping: 'Submix', netGroup: true
};
